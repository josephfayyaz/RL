...
MODEL_SAVE_DIR = MODELS_DIR / "reinforce_vanilla"
TRAIN_LOG_PATH = LOGS_DIR / "vanilla" / "training_Reinforce_vanilla_source_5M.csv"
FINAL_MODEL_PATH = MODEL_SAVE_DIR / "model_reinforce_vanilla_source_5M.mdl"
...
def main():
    ...
    # Setup
    os.makedirs(LOGS_DIR / "vanilla", exist_ok=True)
