...
import csv
from src.env.custom_hopper import *

# 1. Load your saved model
model = PPO.load(r"/home/joseph/python-proj/udr_ES/models/PPO/udr/PPO_udr_ES_False_seed_42_CustomHopper_udr_v0_5000000.zip")
algorithm = "PPO_UDR"
...
csv_path = f"/home/joseph/python-proj/udr_ES/Logs/PPO_robustness/robustness_results_{algorithm}_5M.csv"
...
plt.grid(True)
plt.tight_layout()
plt.savefig(f"/home/joseph/python-proj/udr_ES/render/plots/5M-tmp/noise_robustness_curve_{algorithm}.png", dpi=300)
plt.show()
