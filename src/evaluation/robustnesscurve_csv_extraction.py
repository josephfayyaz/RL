...
model = PPO.load(r".\models\PPO\es\PPO_Domain_source_ES_True_seed_42_CustomHopper_source_v0_CustomHopper.zip")
algorithm = "PPO_es_seed_42"
...
csv_path = os.path.join("Logs", "PPO_robustness", f"robustness_results_{algorithm}.csv")
...
plt.grid(True)
plt.tight_layout()
plt.savefig(fr".\render\plots\noise_robustness_curve_{algorithm}.png", dpi=300)
